...
- `comp_filter` (Issue #14) — three-layer apple-to-apples filter: `quality_thresholds` (Layer-1 binary + Layer-2 soft trigger), `quality_deductions` (Layer-2 amounts), `hard_reject_patterns` (4 Layer-1 regex categories), `caddy_mismatch_patterns`, `condition_equivalence` (numeric Phase 2.3 classes), `series_names` (Fabrikam HARD CONTRACT et al)
...
create_listing(
    folder_path="/path/to/Hard Disks/2_5_inch/MDL-A03",
    price=49.99,
    quantity=1,
