...
Live eBay Browse API call against MDL-A11 (or any --part-number override),
...
USAGE:
  uv run python scripts/sample_invocation_issue444.py [--part-number MDL-A11]
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--part-number",
        default="MDL-A11",
        help="MPN to sample (default: MDL-A11 — Issue #14 motivating example).",
    )
    parser.add_argument(
        "--listings",
        type=Path,
